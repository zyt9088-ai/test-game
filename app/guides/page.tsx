  ...
  const games = [
    ...
    },
    {
      ...
      rules: [
        ...
        "• حماية (3 بطاقات): لحماية دولة تم الإجابة عليها ولا تُفك إلا بالقصف (تظهر أيقونة درع). يمكن طلب الحماية قبل دور الخصم.",
        "• قصف (3 بطاقات): لفك حماية دولة، أو لخصم نصف نقاط دولة الخصم إذا لم تكن محمية.",
        "• غزو (بطاقتان): لمهاجمة عاصمة الخصم يجب أن تكون نقاطك أكثر من 5000 ونقاط الخصم أكثر من 10000 ، وفي حال النجاح تأخذ ثلث نقاط الخصم.",
